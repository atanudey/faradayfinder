...
class FormUpdateProject(forms.ModelForm):

    def __init__(self, *args, **kwargs):
        instance = kwargs['instance']
        self.user = instance.user
        super(FormUpdateProject, self).__init__(*args, **kwargs)
...
class FormProjects(forms.ModelForm):

    def __init__(self, *args, **kwargs):
        self.user = kwargs.pop('user', None)
        super(FormProjects, self).__init__(*args, **kwargs)
        fields_name = ['name', 'photo', 'password', 'primary_url',
                       'primary_twitter', 'lab', 'is_private', 'password',
                       'latitude', 'longitude', 'description', 'meta_keyword',
                       'meta_abstract', 'meta_description', 'facebook',
