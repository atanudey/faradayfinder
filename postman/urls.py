...
from .views import (InboxView, SentView, ArchivesView, TrashView,
        WriteView, ReplyView, ForwardView, MessageView, ConversationView,
        ArchiveView, DeleteView, UndeleteView, DeleteforeverView)
...
urlpatterns = [
    ...
    url(r'^forward/(?P<message_id>[\d]+)/$', ForwardView.as_view(), name='forward'),
    ...
    url(r'^delete-forever/$', DeleteforeverView.as_view(), name='delete_forever'),
