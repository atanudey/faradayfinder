...
class BaseWriteForm(forms.ModelForm):
    ...
    def save(self, recipient=None, parent=None, auto_moderators=[]):
        ...
        if parent:
            ...
            if hasattr(parent, 'forward') and parent.forward == True:
                self.instance.thread_id = None
        ...
        if recipient and not hasattr(parent, 'forward'):
...
class FullForwardForm(BaseReplyForm):
    """The complete reply form."""
