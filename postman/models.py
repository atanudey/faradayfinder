...
class MessageManager(models.Manager):
    ...
    def trash(self, user, **kwargs):
        ...
        filters = ({
            ...
            'recipient_delete_forever': False,
            'moderation_status': STATUS_ACCEPTED,
        }, {
            'sender': user,
            'sender_deleted_at__isnull': False,
            'sender_delete_forever': False,
        })
        return self._folder(related, filters, **kwargs)
...
class Message(models.Model):
    ...
    sender_delete_forever = models.BooleanField(_("Deleted forever by sender"), default=False)
    recipient_delete_forever = models.BooleanField(_("Deleted forever by recipient"), default=False)
    # moderation fields
    moderation_status = models.CharField(_("status"), max_length=1, choices=STATUS_CHOICES, default=STATUS_PENDING)
    moderation_by = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='moderated_messages', null=True, blank=True, verbose_name=_("moderator"))
